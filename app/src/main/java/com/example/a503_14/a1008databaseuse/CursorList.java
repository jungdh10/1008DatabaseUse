...
//SimpleAdapterUse와 다르게 자바클래스(DatabaseOpenHelper) 만들어서 불러오기
public class CursorList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //데이터베이스 사용 클래스의 객체 생성 -onCreate가 호출(만든클래스:DatabaseOpenHelper)
        ...
        CursorAdapter cursorAdapter=new SimpleCursorAdapter(this, android.R.layout.simple_list_item_2,
                cursor, new String[]{"name", "alias"}, new int[] {android.R.id.text1, android.R.id.text2}, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
