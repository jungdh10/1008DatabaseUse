...
import com.example.a503_14.a1008databaseuse.R;
import com.example.a503_14.a1008databaseuse.VO;

import java.util.List;

public class MyAdapter extends BaseAdapter {
    //Context를 못만들기 때문에 넘겨받아야함
    //Context 변수 생성
    Context context;
    //출력할 데이터의 List
    List<VO> data;
    ...
    //항목 뷰를 만드는 메소드
    //첫 번째 매개변수는 출력되는 뷰의 인덱스
    //두 번째 매개변수는 이전 셀의 참조(주소)
    //세 번째 매개변수는 출력되는 AdapterView
    @Override
